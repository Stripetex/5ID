...
public class RobotServer {
    ...
    private ArrayList<String> hostNameUser;
    private ArrayList<Integer> portUser;

    public RobotServer(int portNumber) {
        this.portNumber = portNumber;
        this.hostNameUser = new ArrayList<>();
        this.portUser = new ArrayList<>();
        startServer();
    }
    ...
    public void startServer() {
        ...
        while (true) {
            try {
                ...
                clientSocket.
                portUser.add(clientSocket.getPort());
