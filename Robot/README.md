...
Questo "ChatBot" elaborato dal progetto knock knock ha la funzione di almanacco momentaneamento per il calcio.
Posso essere richiesti i risultati di una giornata o un singolo risultato di un campionato.
Il database all'interno prende gli anni dal 2005 a oggi per i campionati: "Serie A","Serie B","La Liga","Premier League".
